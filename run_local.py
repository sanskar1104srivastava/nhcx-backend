"""Single entrypoint for local dev — wires the same pieces API Gateway + Lambda + DynamoDB + SQS
...
def preflight() -> bool:
    print("=== NHCX bridge — local preflight ===")
    ok = True
...
if __name__ == "__main__":
    ...
    import uvicorn
    uvicorn.run("nhcx.main:app", host="0.0.0.0", port=8000, reload=True)
